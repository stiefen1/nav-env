...
# Ships
ship1 = Ship(States3(-150., -200., 180., 0., 0., 0.), integrator=Euler(dt), name="Ship1")
...
screen.play(dt=dt, tf=tf, own_ships_verbose=['enveloppe', 'name', 'forces'], target_ships_verbose=['enveloppe', 'acceleration'])  